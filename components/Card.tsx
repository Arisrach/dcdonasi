    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-2 pt-10">
          ...
          <div className="text-left text-stone-400">Rp. 6.500.000,-</div>
          <div className="text-right text-stone-400">18</div>
        </div>

        {/* Progress bar */}
        <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 mt-2">
          <div className="bg-yellow-300 h-2.5 rounded-full" style={{ width: '75%' }}></div>
        </div>
